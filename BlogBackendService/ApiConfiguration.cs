...
using System;
using BlogBackendService.App_Start;
using BlogBackendService.Utilities;
using BlogBackendService.Configuration;
using BlogBackendService.Services;
using BlogBackendService.Authentication;
using BlogBackendService.Filters;

namespace BlogBackendService
{
    public class ApiConfiguration
    {
        public static void Install(HttpConfiguration config, IAppBuilder app)
        {
            ...
            config
                .EnableSwagger(c => c.SingleApiVersion("v1", "BlogBackendService"))
                .EnableSwaggerUi();
